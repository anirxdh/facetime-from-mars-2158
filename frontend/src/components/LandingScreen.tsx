  ...
  return (
    <div className="flex h-full items-center justify-center">
      <style>{`
        ...
        .signal-bar-fill {
          animation: fill-bar 2.3s ease-out forwards;
        }
        @keyframes count-up {
          0% { --pct: 0; }
          100% { --pct: 100; }
      ...
      <div className="text-center max-w-xl px-6 fade-in">
        ...
        {/* Signal strength bar — pure CSS animation */}
        <div className="mb-8 mx-auto max-w-xs">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-2">
              <div
                className={`w-1.5 h-1.5 rounded-full ${
                  showButton ? "bg-green-400" : "bg-amber-400 animate-pulse"
                }`}
              />
              <span className="text-zinc-400 text-[10px] uppercase tracking-wider">
                {showButton ? "Signal Locked" : "Acquiring Signal"}
              </span>
            </div>
            <span
              className={`text-[10px] font-mono font-bold ${
                showButton ? "text-green-400" : "text-amber-400"
              }`}
            >
              {showButton ? "100%" : ""}
            </span>
          ...
          <div className="h-1.5 bg-zinc-800/80 rounded-full overflow-hidden border border-zinc-700/50">
            <div
              className={`h-full rounded-full signal-bar-fill ${
                showButton
                  ? "bg-gradient-to-r from-green-400 to-green-500"
                  : "bg-gradient-to-r from-amber-500 to-amber-400"
              }`}
              style={{
                boxShadow: showButton ? "0 0 10px rgba(34,197,94,0.3)" : "none",
              }}
            />
          </div>
        </div>
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <span
                    className="text-green-400 text-sm tracking-[0.2em] uppercase font-bold"
