      ...
      <div className="text-center w-full max-w-md">
        ...
        <div className="mx-auto max-w-sm mb-10">
          ...
          <div className="h-2 bg-zinc-800 rounded-full overflow-hidden border border-zinc-700/40">
            <div
              className="h-full w-full rounded-full bg-gradient-to-r from-green-400 to-green-500"
        ...
        {/* Accept button - plain and simple */}
        <div>
          <button
            type="button"
            onClick={() => { onAccept(); }}
          ...
          >
            ...
            <span
              className="text-green-400 text-base tracking-[0.15em] uppercase font-bold"
